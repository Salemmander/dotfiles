...
- Auto-trigger when user mentions work to do, asks about their tasks, or wants to mark something done
...
4. **Querying**: `task next` to see current tasks. Only check when contextually relevant -- never at conversation start.
